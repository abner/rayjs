...
* **Runs in the browser** via a WebAssembly build — the same `.js` game source runs on both the native binary and in any modern browser, no code changes. See [`docs/web_target.md`](docs/web_target.md).
